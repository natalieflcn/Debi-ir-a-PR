const fakeExplorationData = {
  ...
  locations: [
    { id: 1, locationName: "Rey Chino Food", completed: true },
    { id: 2, locationName: "Pool place", completed: false },
    { id: 3, locationName: "El Cafetin", completed: false },
    { id: 4, locationName: "El Yunque", completed: true },
    { id: 5, locationName: "El Morro", completed: false },
    { id: 6, locationName: "Columbian steakhouse", completed: true },
  ],
  images: [
